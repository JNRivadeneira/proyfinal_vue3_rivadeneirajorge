...
<template>
  <div id="navbar_container" class="flex items-center justify-between h-10 lg:h-20 bg-slate-400">
    <!-- <nav> -->
    <div id="top_left_menu" class="flex items-center ml-2">
      ...
      <div id="router_links_group" class="hidden lg:flex lg:ml-5">
